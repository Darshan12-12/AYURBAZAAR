	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">viewfullproduct1</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
				...
				while($row=$result->fetch_assoc())
					...
					<div class="agileinfo_single">
						<div class="col-md-4 agileinfo_single_left">
							...
							<img id="example" src="images/'.$row["pimg"].'" alt=" " class="img-responsive">
						</div>
						...
						<h2>'.$row["pname"].'</h2>
							...
							<div class="snipcart-item block">
								<div class="snipcart-thumb agileinfo_single_right_snipcart">
									<h4 class="m-sing">Rs.'.$row["pprice"].'<span></span></h4>
								</div>
								<div class="snipcart-details agileinfo_single_right_details">
									<form action="cart.php" method="get">
										<p><a href="allactions.php?product_id='.$row["product_id"].'" style="color:DarkGreen;">ADD to Cart</a></p>
									</form>
								</div>
							</div>
						</div>
