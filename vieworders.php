...
<!-- breadcrumbs -->
	<div class="breadcrumbs">
		...
		<table class="table table-striped">
											<tr>
														<th class="bg-primary">OID</th>
													    <th class="bg-primary">PRODUCT_ID</th>
														<th class="bg-primary">PNAME</th>
														<th class="bg-primary">PPRICE</th>
														<th class="bg-primary">PDESC</th>
														<th class="bg-primary">PIMG</th>
														<th class="bg-primary">EMAIL</th>
														<th class="bg-primary">ODATE</th>
																   ...
																   $conn =connectdb();
																	...
																	if($result->num_rows>0)
																	{
																		...
																		echo '<tr>
																			...
																			<td>'.$row["email"].'</td>
																			<td>'.$row["odate"].'</td>
																			<td><a href="allactions.php?oid='.$row["oid"].'"> Delete</a></td>
																		</tr>';
																		}  
																	}
																?>
