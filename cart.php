...
<?php
   ...
   $conn =connectdb();
	...
	<td class="invert">Rs.'.$row["pprice"].'</td>
	<td class="invert">'.$row["pdesc"].'</td>
	</tr>';
}
...
<tr>
						 ...
						 <td colspan="6" align="right";><h2> Total :  <?php echo $total?></h2></td>
						 </tr>
						 ...
						 <td><form name="order" action="allactions.php" method="post">  <input type="submit" style="color:green;" name="btnorder" Value="Place Order"> </form></td>
						   ...
						   <tr>
						   <td>   	<h2 style="font-size: 22px;" class="mb-0"><a href="viewproducts2.php">Continue Shopping</a></h2></td>
						   </tr>
	              </div>			
				</table>
			</div>
