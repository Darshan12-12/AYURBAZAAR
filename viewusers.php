               ...
               <div class="col-md-4">
                  <div class="services_box_main">
                     <div  class="services_box text_align_left">
                        ...
                        <div class="veget">
                           <h3 style="font-size:25px; color:green;">fname:'.$row["fname"].'</h3>
						    <h3 style="font-size:25px; color:green;">fname:'.$row["lname"].'</h3>
						  <h4 style="font-size:22px;color:black;">Email:'.$row["email"].'</h4>
                           
						   
						   
						   <h4 style="font-size:22px;color:black;">city:'.$row["city"].'</h4>
						   
						    <h4 style="font-size:22px;color:black;">Password:'.$row["password"].'</h4>
						   <h4 style="font-size:22px;color:black;">date:'.$row["cdate"].'</h4>
						 
				
                        </div>
                     </div><br>
                     <a class="read_more" href="allactions.php?email='.$row["email"].'"><h3  style="font-size:22px;color:red;font-wi:22px;" >DELETE</h3></a>
                  </div><br><br>
               </div>
...
<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2024 AYURBAZAAR. All rights reserved </p>
			</div>
		</div>
